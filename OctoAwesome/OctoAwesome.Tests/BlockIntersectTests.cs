...
namespace OctoAwesome.Tests
{
    public class BlockIntersectTests
    {
        ...
        public void BlockIntersectPreviousCollision()
        {
            ...
            Assert.Equal(Axis.X, collisionAxis);
        ...
        public void BlockIntersectAxisCheck()
        {
            ...
            Assert.Equal(Axis.Y, collisionAxis);
            Assert.Equal(0.5f, distance);
            ...
            Assert.Equal(Axis.Z, collisionAxis);
            Assert.Equal(0.5f, distance);
