...
namespace OctoAwesome.Json
{
    internal static partial class ThrowHelper
    {
        ...
        {
            throw GetArgumentOutOfRangeException(parameterName, "InvalidNewLine");
        }

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException_IndentCharacter(string parameterName)
        {
            throw GetArgumentOutOfRangeException(parameterName, "InvalidIndentCharacter");
        }

        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException_IndentSize(string parameterName, int minimumSize, int maximumSize)
        {
            throw GetArgumentOutOfRangeException(parameterName, SR.Format("InvalidIndentSize {0} {1}", minimumSize, maximumSize));
        }
        ...
        {
            return GetInvalidOperationException(SR.Format("CallFlushToAvoidDataLoss {0}", _buffered));
        }
        ...
        private static InvalidOperationException GetInvalidOperationException(int currentDepth)
        {
            ...
            {
                return GetInvalidOperationException("Json invalid");
            }
        }
