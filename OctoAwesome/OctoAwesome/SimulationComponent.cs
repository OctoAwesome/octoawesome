...
namespace OctoAwesome
{
    public abstract class SimulationComponent : Component
    {
        ...
        public SimulationComponent(params Type[] paramtypes)
        {
            registeredentities = new List<Entity>();
            Types = paramtypes.ToList();
        }
        public void Add(Entity entity)
        {
            if (Types.All(t => entity.Components.ContainsComponent(t)))
                registeredentities.Add(entity);
        }
        public void Calc(GameTime gameTime)
        {
            foreach (Entity entity in registeredentities)
                OnCalc(entity, gameTime);
        }
        protected abstract void OnCalc(Entity entity, GameTime gameTime);
    }
    #region Obsolet
    ///// <summary>
    ...
    //            return true;
    //        return componentFilter.Any(x => x.All(t => entity.Components.Any(c => t.IsAssignableFrom(c.GetType()))));
    //    }
